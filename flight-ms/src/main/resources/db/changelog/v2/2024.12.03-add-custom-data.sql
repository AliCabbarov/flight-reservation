insert into flight.airline (id, created_date, updated_date, created_by, updated_by, status, name)
values  (100, '2024-12-03 14:19:21.650744', null, 0, null, true, 'THY');

insert into flight.plane_place (id, created_date, updated_date, created_by, updated_by, status, place, row, place_number, place_type)
...
insert into flight.plane (id, created_date, updated_date, created_by, updated_by, status, name, capacity, airline_id)
values  (116, '2024-12-03 14:32:20.539444', null, 0, null, true, 'Boing-777', 6, 100);

insert into flight.plane_plane_places (plane_id, plane_places_id)
values  (116, 108),
        (116, 107),
        (116, 105),
        (116, 103),
...
insert into flight.flight (id, created_date, updated_date, created_by, updated_by, status, "from", "to", price, ticket_count, departure_time, arrival_time, plane_id, approval_state, feedback_message)
