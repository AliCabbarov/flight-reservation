...
import ingress.userms.model.entity.Verification;
...
import ingress.userms.repository.VerificationRepository;
...
public class PasswordServiceImpl implements PasswordService {
    ...
    public void changePassword(ChangePasswordDto dto, String token, HttpServletResponse response) {
        ...
        String email = jwtService.getUsername(tkn, response);
