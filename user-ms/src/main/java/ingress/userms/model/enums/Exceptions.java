package ingress.userms.model.enums;
...
public enum Exceptions implements AbstractException {
    ...
    BAD_CREDENTIALS("exception.bad.credentials", "exception.bad.credentials.detail", HttpStatus.BAD_REQUEST),
    ...
    TOKEN_EXPIRED_EXCEPTION("exception.token.expired", "exception.token.expired.detail", HttpStatus.BAD_REQUEST),
